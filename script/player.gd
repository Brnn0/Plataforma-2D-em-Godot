...
@onready var area_collisionStand: CollisionShape2D = $Area2D/AreaCollisionStand
@onready var area_collisionCrouch: CollisionShape2D = $Area2D/AreaCollisionCrouch
